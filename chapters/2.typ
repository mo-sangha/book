...
#quote(block: true, attribution: [Patrul Rinpoche @dalai-lama-dzogchen])[ // p.73
  In this way, always remind yourself of the view, which is the clear light
  recognized in you as your true nature, and rest in that state. Apart from that,
  the crucial point is neither to suppress nor indulge, neither accept nor reject,
  in any way, the thoughts or emotions which are the energy of rigpa:
...
#quote(block: true, attribution: [Longchenpa @treasure-trove])[ // p.275
  ...
  reifies sense objects as having identity, and is unable to "stay in one place" without being
  caught up in sense objects---is a confined space. And so forge the path with unobstructed,
  nonconceptual timeless awareness, free of ordinary consciousness that engages in thinking
...
#quote(block: true, attribution: [Khenpo Gangshar @lotsawa-naturally-liberating])[
  Learn to make this distinction between awareness and mind or thought;
  rely on the stability of the former and purify the latter.
...
#quote(block: true, attribution: [Longchenpa @treasure-trove])[
  ...
  to your five senses or when denial or affirmation, ingrained fixations, or strong
  afflictive emotions occur in your mind.
...
#quote(block: true, attribution: [Longchenpa @treasure-trove])[ // p.233
  ...
  you recognize bare awareness in all its nakedness, and so you need not rely
  on any other factor whatsoever. In that context, the bare state of awareness
  in all its nakedness (which cuts through mental ties to the three times)
  is spontaneously present as a supreme state of equalness that is utterly lucid,
  for it arises naturally as the enlightened intent of naturally settled dharmakaya.
  No matter what arises in this state, do not reflect back on what has passed,
  do not think ahead about what is yet to come, and do not analyze the present moment
  in between. Rather, ensure that you do not stray from the recognition of bare
...
#quote(block: true, attribution: [Longchenpa @treasure-trove])[ // p.234
  ...
  contrivance and do not stray from that recognition, thus cutting through the
  continuity of the three times, enlightened intent arises naturally
